...
/***/ 12:
/*!**********************************************!*\
  !*** D:/project/MiniGameMall/store/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    getCode: function getCode(state, newValue) {
      state.code = newValue;
    },
    setUserInfo: function setUserInfo(state, newValue) {
      state.userInfo = newValue;
    },
    setAddressEdit: function setAddressEdit(state, newValue) {
      state.addressEdit = newValue;
    },
    setCartNum: function setCartNum(state, newValue) {
      state.cartNum = newValue;
    },
    setCartOrder: function setCartOrder(state, newValue) {
      state.cartOrder = newValue;
    },
    setKey: function setKey(state, newValue) {
      state.key = newValue;
    },
    setType: function setType(state, newValue) {
      state.typeNumber = newValue;
    },
    setTempAddress: function setTempAddress(state, newValue) {
      state.tempAddress = newValue;
    },
    setDownResult: function setDownResult(state, newValue) {
      state.downResult = newValue;
    },
    setEvaluateGoods: function setEvaluateGoods(state, newValue) {
...
/***/ 130:
/*!***********************************************************!*\
  !*** D:/project/MiniGameMall/utils/base64-arraybuffer.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!**************************************************!*\
  !*** D:/project/MiniGameMall/utils/interface.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 15));
...
var interfaceurl = (_interfaceurl = {
          ...
          uni.request({
            ...
            success: function success(res) {
              ...
              then(function (res) {
                ...
                console.log('授权用户信息');
                console.log(detail);
                _store.default.commit('setUserInfo', res.data);
  ...
  //授权用户登录
  wxLogin: function wxLogin(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/auth/login.do"), data: data, method: 'POST' });},
  //产品分类
  productType: function productType(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/type.do"), data: data }, false);},
  //产品信息
  productPage: function productPage(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/page.do"), data: data, method: 'POST' }, false);},
  //好玩推荐
  recommend: function recommend(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/index/recommend.do"), data: data }, false);} }, _defineProperty(_interfaceurl, "productPage", function productPage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/page.do"), data: data, method: 'POST' }, false);}), _defineProperty(_interfaceurl, "advert", function advert(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/index/advert.do"), data: data }, false);}), _defineProperty(_interfaceurl, "activityCoupon", function activityCoupon(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/index/activity.do"), data: data }, false);}), _defineProperty(_interfaceurl, "activityDetail", function activityDetail(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/activity/detail.do"), data: data }, false);}), _defineProperty(_interfaceurl, "comment", function comment(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/comment.do"), data: data, method: 'POST' }, false);}), _defineProperty(_interfaceurl, "newEquipment", function newEquipment(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/index/equipment.do"), data: data }, false);}), _defineProperty(_interfaceurl, "attrList", function attrList(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/attrList.do"), data: data }, false);}), _defineProperty(_interfaceurl, "fee", function fee(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/exp/fee.do"), data: data, method: 'POST' }, false);}), _defineProperty(_interfaceurl, "search", function search(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/search.do"), data: data, method: 'POST' }, false);}), _defineProperty(_interfaceurl, "qrcode", function qrcode(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/getQrcode.do"), data: data, method: 'POST' }, false);}), _defineProperty(_interfaceurl, "checkAuth", function checkAuth(


bussinessInterfaceurl, data) {var isAuth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  return new Promise(function (resolve, reject) {
    if (isAuth) {
...
}), _defineProperty(_interfaceurl, "getMobile", function getMobile(


data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/auth/getMobile.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "collection", function collection(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/collection/page.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addCollection", function addCollection(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/collection/store.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "delCollection", function delCollection(

data) {return _request.default.request({ url: "".concat(baseUrl, "//mp/auth/collection/delete.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "couponManage", function couponManage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/users/coupon.do"), data: data });}), _defineProperty(_interfaceurl, "orderManage", function orderManage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/page.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "orderDetail", function orderDetail(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/detail.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "billManage", function billManage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/users/bill.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "equipmentPage", function equipmentPage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/equipment/page.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "equipmentSave", function equipmentSave(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/equipment/saveOrUpdate.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "equipmentDelete", function equipmentDelete(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/equipment/delete.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "cartPage", function cartPage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/cart/page.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addCart", function addCart(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/cart/store.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "delCart", function delCart(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/cart/delete.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addressPage", function addressPage(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/address/page.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addressDelete", function addressDelete(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/address/delete.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addressSave", function addressSave(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/address/saveOrUpdate.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "buildOrder", function buildOrder(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/buildOrder.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "pay", function pay(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/payment/pay.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "bindGame", function bindGame(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/game/bind.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "downInfo", function downInfo(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/game/downInfo.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "defaultAddress", function defaultAddress(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/address/default.do"), data: data });}), _defineProperty(_interfaceurl, "orderCancel", function orderCancel(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/cancel.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "orderDelete", function orderDelete(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/delete.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "collectFlg", function collectFlg(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/collection/collectFlg"), data: data });}), _defineProperty(_interfaceurl, "confirmfinish", function confirmfinish(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/order/confirmFinish.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "addComment", function addComment(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/auth/comment.do"), data: data, method: 'POST' });}), _defineProperty(_interfaceurl, "detail", function detail(

data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/product/detail.do"), data: data });}), _interfaceurl);var _default =
...
/***/ 147:
/*!***************************************************!*\
  !*** D:/project/MiniGameMall/common/city.data.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!************************************************!*\
  !*** D:/project/MiniGameMall/utils/request.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interface = _interopRequireDefault(__webpack_require__(/*! ./interface.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //引入全局变量的token
...
/***/ 19:
/*!**************************************************!*\
  !*** D:/project/MiniGameMall/style/iconfont.css ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 253:
/*!*********************************************************************************!*\
  !*** D:/project/MiniGameMall/components/mpvue-citypicker/city-data/province.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 254:
/*!*****************************************************************************!*\
  !*** D:/project/MiniGameMall/components/mpvue-citypicker/city-data/city.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 255:
/*!*****************************************************************************!*\
  !*** D:/project/MiniGameMall/components/mpvue-citypicker/city-data/area.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!******************************************!*\
  !*** D:/project/MiniGameMall/pages.json ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!***********************************************************!*\
  !*** D:/project/MiniGameMall/pages.json?{"type":"style"} ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/shop/index": { "navigationBarTitleText": "商店" }, "pages/my/index": { "navigationBarTitleText": "我的", "navigationBarBackgroundColor": "#ECD038" }, "pages/index/index": { "navigationBarTitleText": "思迪互动" }, "pages/find/index": { "navigationBarTitleText": "发现" }, "pages/my/order/ordermanagement": { "navigationBarTitleText": "订单管理" }, "pages/my/order/orderdetail": { "navigationBarTitleText": "订单详情", "navigationBarBackgroundColor": "#FD5E2D", "navigationBarTextStyle": "white" }, "pages/my/order/ordersigning": { "navigationBarTitleText": "订单详情", "navigationBarBackgroundColor": "#FD5E2D", "navigationBarTextStyle": "white" }, "pages/my/order/evaluate": { "navigationBarTitleText": "评论" }, "pages/my/mine/adddevice": { "navigationBarTitleText": "确认订单" }, "pages/my/mine/newdevice": { "navigationBarTitleText": "添加设备" }, "pages/my/mine/billmanagement": { "navigationBarTitleText": "账单管理", "navigationBarBackgroundColor": "#F0F0F0" }, "pages/my/mine/coupon": { "navigationBarTitleText": "我的卡包" }, "pages/my/mine/collection": { "navigationBarTitleText": "我的收藏" }, "pages/my/mine/poster": { "navigationBarTitleText": "邀请用户专属海报" }, "pages/my/mine/systemsetup": { "navigationBarTitleText": "系统设置" }, "pages/shop/cart/editaddress": { "navigationBarTitleText": "编辑地址" }, "pages/shop/cart/addaddress": { "navigationBarTitleText": "确认订单" }, "pages/shop/cart/orderpay": { "navigationBarTitleText": "确认订单" }, "pages/shop/cart/goodsdetail": { "navigationBarTitleText": "商品详情" }, "pages/shop/cart/cart": { "navigationBarTitleText": "购物车" }, "pages/index/help/activitydetails": { "navigationBarTitleText": "活动详情" }, "pages/index/help/search": { "navigationBarTitleText": "搜索" }, "pages/index/help/customer": { "navigationBarTitleText": "联系客服" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!**********************************************************!*\
  !*** D:/project/MiniGameMall/pages.json?{"type":"stat"} ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__9FC776C" };exports.default = _default;
